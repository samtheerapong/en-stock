      ...
      <div class="row">
        ...
        <div class="panel panel-primary">
          <div class="panel-heading">
            <h3 class="panel-title">คลังเก็บอะไหล่</h3>
          </div>
          <!-- /.panel-header -->
        ...
        <form role="form" action="<?php echo base_url('stores/create') ?>" method="post" id="createForm">
          ...
          <div class="modal-body">
            ...
            <div class="form-group">
              <label for="brand_name">ชื่อคลัง</label>
              <input type="text" class="form-control" id="store_name" name="store_name" placeholder="" autocomplete="off">
            </div>
            <div class="form-group">
      ...
      <div class="modal-content">
        ...
        <form role="form" action="<?php echo base_url('stores/update') ?>" method="post" id="updateForm">
          ...
          <div class="modal-body">
            ...
            <div class="form-group">
              <label for="edit_brand_name">ชื่อคลัง</label>
              <input type="text" class="form-control" id="edit_store_name" name="edit_store_name" placeholder="" autocomplete="off">
            </div>
            <div class="form-group">
