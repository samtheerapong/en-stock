	...
	public function fetchStoresData()
	{
		...
		foreach ($data as $key => $value) {
			...
			if(in_array('updateStore', $this->permission)) {
				$buttons = '<button type="button" class="btn btn-warning btn-sm" onclick="editFunc('.$value['id'].')" data-toggle="modal" data-target="#editModal"><i class="fa fa-pencil"></i> แก้ไข</button>';
			}
